...
class HybridNets():
	...
	def __init__(self, model_path, anchor_path, conf_thres=0.25, iou_thres=0.5):
	...
	def draw_segmentation(self, image, alpha = 0.5):
		...
		# return util_draw_seg(self.seg_map, blank_image, alpha)
	...
	def draw_all(self, image, horizon_points, alpha = 0.5):
		...
		seg_view = self.draw_segmentation(image, alpha)
